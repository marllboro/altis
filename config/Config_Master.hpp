...
/* Database Related Settings */
    ...
    save_vehicle_items[] = { "pickaxe","fuelEmpty","fuelFull", "lockpick", "defuseKit","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","toolkit" };//, "spikeStrip","storageSmall","storageBig","defibrillator"
...
//  cop_extendedSkins = false; //Enable or disable cop skins by level. Before enabling, you must add all the EIGHT files to textures folder. (It must be named as: cop_uniform.jpg + cop_uniform_1.jpg, cop_uniform_2.jpg...cop_uniform_6.jpg, cop_uniform_7.jpg; meaning cop_uniform = life_coplevel=0, cop_uniform_1 = life_coplevel=1, cop_uniform_2 = life_coplevel=2, etc...)
    ...
    revive_fee = 35000; //Revive fee that players have to pay and medics only EMS(independent) are rewarded with this amount.
    ...
    paycheck_cop = 13500; //Payment for cops
    paycheck_civ = 10000; //Payment for civillians
    paycheck_med = 19500; //Payment for medics
    ...
    /* AIR DROP */
    enable_airdrop = 1;                 //Enable Airdrop?
    airdrop_markerSize = 300;           //Change Size of radius of airdrop (Change if need be. 500 is pretty decent size)
    players_needed_drop_civ = 1;        //How many Civ online for the drop to occur
    players_needed_drop_cop = 0;        //NOT YET USED. DO NOT EDIT!
    airdrop_time = 0.5;                   //Time in hours for the airdrop to take place
